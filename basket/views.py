...
def update_basket(request, slug):
    ...
    start_total_bigbasket = 0.00
    start_total_flipkart = 0.00
    start_total_amazon = 0.00

    for item in basket.basketitem_set.all():
        product_total_bigbasket = float(item.product.price_bigbasket) * item.quantity
        ...
        start_total_bigbasket += product_total_bigbasket
    ...
    basket.total_bigbasket = start_total_bigbasket
